...
#visualise the data and decide which lower thresholds for the diameter and diameter_3d should be taken
...
for i, df in enumerate(df_list_eye_id0):
    ...
    stim_end = stim_start + 3.4
    after_var_start = stim_end
    after_var_end = after_var_start + 21.6
...
#Analysis eye_id1, same steps as before
...
for i, df in enumerate(df_list_eye_id1_preprocessed_1):
    ...
    # Calculate masked first derivative of the dataframe
    df_preprocessed_eye_id1_i = PLR3d.mask_pupil_confidence_3d([df_preprocessed_eye_id1_i], threshold=confidence_threshold_1)[0]
    df_preprocessed_eye_id1_i = PLR3d.remove_threshold_3d([df_preprocessed_eye_id1_i], lower_threshold=diameter_3d_threshold_eye1, upper_threshold=12, mask_cols=['diameter_3d'])[0]
    df_preprocessed_eye_id1_i = PLR3d.iqr_threshold_3d([df_preprocessed_eye_id1_i], iqr_factor=4, mask_cols=['diameter_3d'])[0]
    df_preprocessed_eye_id1_i = PLR3d.mask_pupil_zscore_3d([df_preprocessed_eye_id1_i], threshold=3.0, mask_cols=["diameter_3d"])[0]
    df_preprocessed_eye_id1_i = PLR3d.mask_pupil_first_derivative_3d([df_preprocessed_eye_id1_i])[0]
