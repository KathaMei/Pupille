...
class PLR3d:
    ...
    def mask_pupil_zscore_3d(
            df_list: List[pd.DataFrame],
            threshold: float = 3.0,
            mask_cols: List[str] = ["diameter_3d"],
        ) -> List[pd.DataFrame]:
            """
    ...
    def mask_pupil_first_derivative_3d(
        df_list: List[pd.DataFrame],
        threshold: float = 3.0,
        mask_cols: List[str] = ["diameter_3d"],
    ) -> List[pd.DataFrame]:
    ...
    def mask_pupil_confidence_3d(
        ...
        below threshold. Pupil Labs recommend a threshold of 0.8. Helpful for
        dealing with blinks.
        Parameters
        ----------
        df_list : List[pd.DataFrame]
    ...
    def wait_for_input():
        """
        Wait for user to press Enter to continue running the program.
        """
